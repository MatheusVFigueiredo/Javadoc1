...
public class PET extends Projeto{
	...
	public PET(int cod, String nome, String objetivo, int impacto, int rendimento, int prodTecnica, int prodAcademica, int patentes, Date data, int duracao) throws Exception{
