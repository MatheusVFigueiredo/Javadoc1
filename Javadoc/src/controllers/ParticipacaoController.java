...
public class ParticipacaoController {
	...
	public void removeParticipacao(String cpf, int codigo) throws Exception{
		try{
			...
			throw new Exception(Util.ERRO_REMOCAO_PARTICIPACAO + e.getMessage());
		}
	}
	...
	public boolean verificaProfessor(int codigo, boolean coordenador) throws Exception{
		Projeto projeto = repositoryprojeto.getProjeto(codigo);
	...
	public boolean verificaGraduando(int codigo) throws Exception{
		Projeto projeto = repositoryprojeto.getProjeto(codigo);
	...
	public boolean verificaParticipacao(int codigo, String cpf) throws Exception{
		Projeto projeto = repositoryprojeto.getProjeto(codigo);
     ...
     *            - cpf unico da pessoa.
     *            
     * @return - valor total da bolsa de uma pessoa especifica.
     *            
     * @throws Exception
     *             - excecao lancada caso ocorra algum erro.
     */
	...
	public void verificaCodigoCpf(String cpf, int codigo) throws Exception{
		if(!repositoryprojeto.verificaProjetoCadastrado(codigo)) throw new Exception(ExcecoesProjetos.ERRO_PROJETO_INEXISTENTE);
		if(!repositorypessoa.verificaCpfCadastrado(cpf)) throw new Exception(ExcecoesPessoas.ERRO_PESSOA_INEXISTENTE);
	}
